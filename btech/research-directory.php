...
<head>
	...
	<meta name="description" content="Research Directory">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						...
						<p><span><a href="index.php">Home <i class='fa fa-angle-right'></i></a></span> <span class="b-active"> Research Directory</span></p> 
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
